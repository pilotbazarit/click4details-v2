              ...
              {!loading && products?.length > 0 ? (
                products.map((item, index) => (
                  <TableRow key={item.id || index} className="border-b border-gray-200">
                    ...
                    <TableCell className="border-r border-gray-200 font-medium py-4">{item?.v_model_name}</TableCell>
                    ...
                    <TableCell className="border-r border-gray-200 font-medium py-4">{item?.v_availability_name}</TableCell>
