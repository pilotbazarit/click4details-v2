...
import { Archive, DollarSign, Funnel, Loader2, Pencil, ShieldMinus, Trash2 } from "lucide-react";
...
const ProductList = () => {
    ...
    const handleArchiveDelete = async (id) => {
        const result = await Swal.fire({
            title: "Are you sure?",
            text: "You want to archive delete this!",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
        ...
        <div className="flex flex-col min-h-screen w-full justify-between bg-gray-50 px-6">
            <main className="mx-auto bg-white rounded-lg shadow-lg border border-gray-200 p-6 my-6 w-full">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                    <h2 className="text-xl text-gray-800">Recycled Product List</h2>
                    <Button
                        onClick={handleAdd}
