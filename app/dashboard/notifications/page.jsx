            ...
            <div className="p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 text-sm">
                <div className="min-w-0">
                  ...
                  <p className="font-medium text-gray-900 truncate">{highlightedNotification.customer_name ?? "—"}</p>
                </div>
                <div className="min-w-0">
                  <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Mobile Number</p>
                  <div className="flex items-center gap-2">
                    <p className="text-gray-900 truncate">{highlightedNotification.mobile_number ?? "—"}</p>
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-900">{highlightedNotification.search_by ?? "—"}</p>
                </div>
                <div className="min-w-0">
                  <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Search By User Role</p>
                  <p className="font-medium text-gray-900">{highlightedNotification.search_by_user_role ?? "—"}</p>
                </div>
                <div className="min-w-0">
              ...
              <div className="mt-5 pt-5 border-t border-gray-100">
                ...
                <p className="text-gray-900 text-sm leading-relaxed" title={highlightedNotification.search_history}>{highlightedNotification.search_history ?? "—"}</p>
              </div>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 text-sm">
                      <div className="min-w-0">
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Customer Name</p>
                        <p className="font-medium text-gray-900 truncate">{n.customer_name ?? "—"}</p>
                      </div>
                      <div className="min-w-0">
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Mobile Number</p>
                        <div className="flex items-center gap-2">
                          <p className="text-gray-900 truncate">{n.mobile_number ?? "—"}</p>
                          <button
                            type="button"
                      ...
                      <div className="min-w-0">
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Search By</p>
                        <p className="text-gray-900">{n.search_by ?? "—"}</p>
                      </div>
                      <div className="min-w-0">
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Search By User Role</p>
                        <p className="font-medium text-gray-900">{n.search_by_user_role ?? "—"}</p>
                      </div>
                      <div className="min-w-0">
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Search Date and Time</p>
                    ...
                    <div className="mt-5 pt-5 border-t border-gray-100">
                      <p className="text-xs font-medium text-[#0167a2] uppercase tracking-wide mb-1.5">Search History</p>
                      <p className="text-gray-900 text-sm leading-relaxed" title={n.search_history}>{n.search_history ?? "—"}</p>
                    </div>
                  </div>
                </li>
              );
