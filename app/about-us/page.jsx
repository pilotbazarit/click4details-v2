...
const freeBenefits = [
    ...
    'শপ ম্যানেজমেন্ট',
    'প্রোডাক্টের দেশজুড়ে ডিজিটাল ডিস্ট্রিবিউশন',
    'বিক্রি বৃদ্ধি',
    'আরও কত কী',
    'সব ফ্রি, সব ফ্রি',
];
                        ...
                        <div className="flex flex-col items-start w-full md:px-10 pt-8 relative">
                            ...
                            <div className="w-full mt-4 text-gray-600 text-xl text-start mt-2 mb-2">
                                <div className="text-xl sm:text-2xl leading-relaxed">
                                    ...
                                    <div className="mt-8">
                                        <p className="font-bold text-red-600 underline underline-offset-4">আমি এই ধৈর্য ধরতে পারবোনা</p>
                                    ...
                                    <div className="mt-8">
                                        ...
                                        <p className='text-red-600'>তাহলে কালকে থেকেই আপনার গাড়ী বিক্রি হবে</p>
                                    </div>
                            ...
                            <div className="mt-8 rounded-xl mb-2">
                                ...
                                <p className='text-red-600 text-md sm:text-2xl mb-3'>স্টক পেজ থেকে গাড়ি নিয়ে পুঁজি ছাড়াই ব্যবসা করার সুযোগ নিন।  </p>
                                ...
                                <div className="space-y-2 text-xl sm:text-2xl">
                                    <p>✅ কাস্টমারের চাহিদা অনুযায়ী স্টক পেজ থেকে গাড়ি খুঁজুন</p>
                                    <p>✅ গাড়ি স্টক পেজ থেকে আপনার মাই-শপে নিয়ে আসুন</p>
                                    <p>✅ দাম পরিবর্তন করে আপনার কাস্টমারের কাছে গাড়ীর তথ্য ও ছবি পাঠান</p>
                                    <p>✅ কাস্টমার গাড়ী পছন্দ করলে আমাদের থেকে গাড়ি নিয়ে কাস্টমারকে গাড়ী দিন</p>
                                ...
                                <div className="space-y-5 text-xl font-medium leading-relaxed">
                                    ...
                                    <div className="mt-7 text-left text-[17px] sm:text-[19px] md:text-[21px] font-medium leading-relaxed">
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <ul className="mt-2 list-disc space-y-2 pl-7">
                                                <li>
                                                    মার্কেটিং এবং ডিলারা আপনার গাড়ীর তথ্য অনুযায়ী কাস্টমারের কাছে গাড়ি বিক্রি করবে।
                                                </li>
                                                <li>
