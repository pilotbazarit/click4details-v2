        ...
        <>
            <div className="flex flex-col items-center justify-center md:px-10 pt-8 relative">
                <div className="absolute inset-0 pointer-events-none">
                    <div className="w-40 h-40 bg-blue-100 rounded-full blur-2xl opacity-60 absolute -top-10 -left-10"></div>
                    <div className="w-32 h-32 bg-blue-200 rounded-full blur-2xl opacity-40 absolute top-10 right-0"></div>
                </div>
                <h1 className="text-3xl md:text-4xl font-extrabold z-10 tracking-tight flex items-center gap-3" style={{ color: "#116fa5" }}>
                    <span className="inline-block text-[#0469a3]">
                ...
                <div className="w-24 h-1 bg-gradient-to-r from-[#0469a3] to-blue-300 rounded-full mt-3 z-10"></div>
