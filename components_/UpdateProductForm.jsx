                                    ...
                                    <div className="mt-4 mb-4">
                                        ...
                                        <div className="flex items-center mt-4">
                                            ...
                                            <label htmlFor="want_to_be_partner" className={`text-sm ${(user?.user_mode == 'partner' || user?.user_mode == 'user') ? 'text-gray-400' : 'text-gray-600'}`}>
                                                I Want to be a Partner of click4detils.com. Please Click the Checkbox and Submit to be Our Partner. If You Click the Checkbox click4detils.com team will Call You Soon. Or Call click4detils.com Hotline Number 01969444000 to be Our Partner. &nbsp;
                                            </label>
                                        </div>
