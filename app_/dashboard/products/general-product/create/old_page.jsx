...
const schema = yup.object().shape({
    ...
    // code: yu/p.string().required("Code is required"),
    location: yup.string().required("Location is required"),
    outlet: yup.string().required("Outlet is required"),
    category: yup.number().positive("Category is required").required("Category is required"),
    country: yup.string().required("Country is required"),
    serialNumber: yup.string().required("Serial number is required"),
    videoLink: yup.string().url("Must be a valid URL").nullable(),
    pbl_description: yup.string().required("PBL Description is required"),
    special_description: yup.string().required("Special Description is required"),
    ...
    attributes: yup.array().of(
        yup.object().shape({
            attribute_id: yup.string().required("Feature is required"),
            attribute_value_id: yup.string().required("Feature item is required"),
        })
    ),
    extraInfo: yup.array().of(
        yup.object().shape({
            title: yup.string().required("Information title is required"),
            value: yup.string().required("Information value is required"),
        })
    ),
});
...
const GeneralProductCreate = () => {
    ...
    useEffect(() => {
        const parentId = categoryHistory[categoryHistory.length - 1]?.c_id || 0;
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 mb-4">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="relative" ref={categoryDropdownRef}>
                                    <div onClick={() => setIsCategoryListVisible(!isCategoryListVisible)} className="cursor-pointer flex justify-between items-center border rounded-lg p-2 bg-white shadow-sm">
                                        <span className="text-sm text-gray-500">
                                            {categoryHistory.length === 0 && "Select a category..."}
                            ...
                            {/* Package */}
                            <div className="flex flex-col gap-1">
                                <label className="text-base font-medium" htmlFor="package">
                                    Package
                                </label>
                                <Controller
                                    name="package"
                                        ...
                                        <div className="flex-1">
                                            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    <Controller name={`prices.${index}.purchase_price`} control={control} render={({ field }) => <input {...field} type="number" className="outline-none py-2 px-4 rounded border border-gray-300 focus:border-orange-500 transition" />} />
                                                </div>
                                                <div className="flex flex-col gap-1">
                                                    <label className="text-base font-medium">Regular Price</label>
                                                    <Controller name={`prices.${index}.regular_price`} control={control} render={({ field }) => <input {...field} type="number" className="outline-none py-2 px-4 rounded border border-gray-300 focus:border-orange-500 transition" />} />
                                                </div>
                                                <div className="flex flex-col gap-1">
                                                    <label className="text-base font-medium">Discount</label>
                                                    <Controller name={`prices.${index}.discount`} control={control} render={({ field }) => <input {...field} type="number" className="outline-none py-2 px-4 rounded border border-gray-300 focus:border-orange-500 transition" />} />
                                                </div>
                                                <div className="flex flex-col gap-1">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 w-full mt-4">
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    <Controller name={`prices.${index}.unit_count`} control={control} render={({ field }) => <input {...field} type="text" className="outline-none py-2 px-4 rounded border border-gray-300 focus:border-orange-500 transition" />} />
                                                </div>
                                                <div className="flex flex-col gap-1">
