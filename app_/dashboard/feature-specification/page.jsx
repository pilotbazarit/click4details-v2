...
const Model = () => {
  ...
  const canShowEditFeatureSpecificationButton =
    (user?.user_mode !== "pbl" && user?.user_mode !== "admin") ||
    hasPermission(permissionList, 0, "FeatureSpecification", "ShowFeatureSpecificationEditButton")


  const canShowDeleteFeatureSpecificationButton =
    (user?.user_mode !== "pbl" && user?.user_mode !== "admin") ||
    hasPermission(permissionList, 0, "FeatureSpecification", "ShowFeatureSpecificationDeleteButton")
  ...
  useEffect(() => {
    getFeatureSpecification(searchQuery, currentPage, itemsPerPage);
                ...
                featureSpecification.map((item, index) => (
                  <TableRow key={item.id || index} className="border-b border-gray-200">
                    ...
                    <TableCell className="flex justify-end gap-2 border-r border-gray-200 font-medium">
                      {
                        canShowEditFeatureSpecificationButton && (
                          <button
                      ...
                      {
                        canShowDeleteFeatureSpecificationButton && (
                          <button
