...
const FollowupsDataTable = () => {
  ...
  const canShowAddFollowupButton =
    (user?.user_mode !== "pbl" && user?.user_mode !== "admin") ||
    hasPermission(permissionList, 0, "Followup", "ShowFollowupAddButton")

  const canShowEditFollowupButton =
    (user?.user_mode !== "pbl" && user?.user_mode !== "admin") ||
    hasPermission(permissionList, 0, "Followup", "ShowFollowupEditButton")

  const canShowDeleteFollowupButton =
    (user?.user_mode !== "pbl" && user?.user_mode !== "admin") ||
    hasPermission(permissionList, 0, "Followup", "ShowFollowupDeleteButton")
