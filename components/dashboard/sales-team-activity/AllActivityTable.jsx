        ...
        <tr key={row.id} className="hover:bg-gray-50 align-top">
          ...
          <td className="w-14 px-2 py-2 whitespace-nowrap text-center">
            <div className="relative inline-flex">
              ...
              {canManageActivityRow(row) && actionMenuRowId === row.id && (
                <div className="absolute right-0 top-9 z-20 min-w-[140px] rounded-md border border-slate-200 bg-white py-1 shadow-lg">
