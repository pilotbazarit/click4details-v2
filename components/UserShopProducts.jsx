...
import { useUserShopProductContext } from "@/context/UserShopProductContext";

const UserShopProducts = () => {
  const { products, loading, hasMore, getAllProduct, user } = useUserShopProductContext();
      ...
      >
        {
          products.length === 0 && !loading ? (
            ...
            products.map((product, index) => {
              ...
              return <ProductCard key={index} product={product} parsedUser={parsedUser} />;
            })
        }
