...
/** Shop-0 grant that unlocks Sales Team Activity like supreme (menu + all records/actions). */
export function hasSalesTeamActivityMenuShow(permissionList) {
  return (
    hasPermission(permissionList, 0, "CustomerCare", "SalesTeamActivityMenuShow") ||
    hasPermission(permissionList, 0, "SalesTeamActivity", "SalesTeamActivityMenuShow")
  );
}
